  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MoviesDetailsBloc>()
        ..add(GetMoviesDetailEvent(id))
        ..add(GetMoviesRecommendationsEvent(id)),
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesDetailsBloc, MoviesDetailsState>(
      builder: (context, state) {
        switch (state.moviesDetailState) {
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConstance.imageUrl(
                              state.moviesDetail!.backdropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.moviesDetail!.releaseDate.split('-')[0],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    (state.moviesDetail!.voteAverage / 2)
                                        .toStringAsFixed(1),
                                    style: const TextStyle(
                                      fontSize: 16.0,
                                      fontWeight: FontWeight.w500,
                                  ...
                                  const SizedBox(width: 4.0),
                                  Text(
                                    '(${state.moviesDetail!.voteAverage})',
                                    style: const TextStyle(
                                      fontSize: 1.0,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: 1.2,
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            '${AppString.genres}: ${_showGenres(state.moviesDetail!.genres)}',
                            style: const TextStyle(
